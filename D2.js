...
if (totalShoppingCart > 50) {
  console.log(`Il totale del carrello è ${totalShoppingCart}, quindi la spedizione è gratuita.`);
} else {
  console.log(`Il totale del carrello è ${totalShoppingCart}, + costo spedizione di 10 euro = ${totalShoppingCart + shippingCost}`);
